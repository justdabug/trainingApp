...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__player__ = __webpack_require__(2167);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_sync__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_utils_dom__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__providers_utils_time__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__providers_utils_url__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__providers_utils_utils__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__app_app_component__ = __webpack_require__(1002);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__providers_lesson__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__providers_lesson_offline__ = __webpack_require__(230);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__providers_lesson_sync__ = __webpack_require__(231);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__providers_helper__ = __webpack_require__(1001);
// (C) Copyright 2015 Moodle Pty Ltd.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
var AddonModLessonPlayerPage = /** @class */ (function () {
    function AddonModLessonPlayerPage(navParams, logger, translate, eventsProvider, sitesProvider, syncProvider, domUtils, popoverCtrl, timeUtils, lessonProvider, lessonHelper, lessonSync, lessonOfflineProvider, cdr, modalCtrl, navCtrl, appProvider, utils, urlUtils, fb, mmApp) {
        ...
        this.fb = fb;
        this.mmApp = mmApp;
        this.component = __WEBPACK_IMPORTED_MODULE_14__providers_lesson__["a" /* AddonModLessonProvider */].COMPONENT;
        this.LESSON_EOL = __WEBPACK_IMPORTED_MODULE_14__providers_lesson__["a" /* AddonModLessonProvider */].LESSON_EOL;
    ...
    AddonModLessonPlayerPage.prototype.jumpToPage = function (pageId) {
        ...
        else if (pageId == __WEBPACK_IMPORTED_MODULE_14__providers_lesson__["a" /* AddonModLessonProvider */].LESSON_EOL) {
        ...
        if (this.review) {
            ...
            promise = this.lessonOfflineProvider.hasFinishedRetake(this.lesson.id).then(function (finished) {
                if (finished) {
                    ...
                    pageId = __WEBPACK_IMPORTED_MODULE_14__providers_lesson__["a" /* AddonModLessonProvider */].LESSON_EOL;
                }
                return {};
            });
        }
    ...
    AddonModLessonPlayerPage.prototype.loadPage = function (pageId) {
        var _this = this;
        if (pageId == __WEBPACK_IMPORTED_MODULE_14__providers_lesson__["a" /* AddonModLessonProvider */].LESSON_EOL) {
            // End of lesson reached.
            return this.finishRetake();
        }
        ...
        return this.callFunction(this.lessonProvider.getPageData.bind(this.lessonProvider), args, 5, 8).then(function (data) {
            if (data.newpageid == __WEBPACK_IMPORTED_MODULE_14__providers_lesson__["a" /* AddonModLessonProvider */].LESSON_EOL) {
                // End of lesson reached.
    ...
    AddonModLessonPlayerPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["t" /* NavParams */], __WEBPACK_IMPORTED_MODULE_6__providers_logger__["a" /* CoreLoggerProvider */], __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["c" /* TranslateService */],
            ...
            __WEBPACK_IMPORTED_MODULE_8__providers_sync__["a" /* CoreSyncProvider */], __WEBPACK_IMPORTED_MODULE_9__providers_utils_dom__["a" /* CoreDomUtilsProvider */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["w" /* PopoverController */],
            __WEBPACK_IMPORTED_MODULE_10__providers_utils_time__["a" /* CoreTimeUtilsProvider */], __WEBPACK_IMPORTED_MODULE_14__providers_lesson__["a" /* AddonModLessonProvider */],
            __WEBPACK_IMPORTED_MODULE_17__providers_helper__["a" /* AddonModLessonHelperProvider */], __WEBPACK_IMPORTED_MODULE_16__providers_lesson_sync__["a" /* AddonModLessonSyncProvider */],
            __WEBPACK_IMPORTED_MODULE_15__providers_lesson_offline__["a" /* AddonModLessonOfflineProvider */], __WEBPACK_IMPORTED_MODULE_0__angular_core__["j" /* ChangeDetectorRef */],
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["q" /* ModalController */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["s" /* NavController */], __WEBPACK_IMPORTED_MODULE_4__providers_app__["a" /* CoreAppProvider */],
            ...
            __WEBPACK_IMPORTED_MODULE_13__app_app_component__["a" /* MoodleMobileApp */]])
